package com.cda.API.ProjetFilRouge.controller;
...
import com.cda.API.ProjetFilRouge.service.Equipement_dragonService;
...
public class Equipement_dragonController {
	...
	public Equipement_dragon update(@PathVariable Long id_equipement_dragon,
			@RequestBody Equipement_dragon equipement_dragon) {
